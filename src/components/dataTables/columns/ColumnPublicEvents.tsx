...
import { PublicEvent } from "@/serverActions/crudPublicEvents";
import { ColumnDef } from "@tanstack/react-table";
import { Button } from "../../ui/button";
import DeleteItemButton from "../action-buttons/ButtonDeletePublicEvent";
import ImageWithFallback from "@/components/ui/imageWithFallback";

export const PublicEventsColumns: ColumnDef<PublicEvent>[] = [
    {
          accessorKey: "image",
          header: "Image",
          cell: ({ row }) => {
